class Anamn < Formula
  ...
  # the assets (anamn-v0.2.0-2). Any re-roll = new tag suffix + url+sha bump
  ...
  on_macos do
    url "https://github.com/TowardInfinity/dots-releases/releases/download/anamn-v0.2.0-2/anamn-darwin-aarch64.tar.gz"
    sha256 "86d774132a842638b5c213168e5f6c374b213139a27d8a0ce7dd597ed7a0f769"
  end
  on_linux do
    url "https://github.com/TowardInfinity/dots-releases/releases/download/anamn-v0.2.0-2/anamn-linux-aarch64.tar.gz"
